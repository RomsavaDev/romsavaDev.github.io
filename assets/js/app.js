  ...
  $('.portfolio-slick').slick(
  	{
  		...
  		fade: true,
  		cssEase: 'linear',
  		prevArrow: '<button type="button" class="slick-prev"><img src="assets/img/icons/arrows(1).svg"/></button>',
  		nextArrow: '<button type="button" class="slick-next"><img src="assets/img/icons/arrows.svg"/></button>'
  	});
});
function map(n){
	...
	var locations = [
		[new google.maps.LatLng(40.7425534,-73.9267361)],
	]
	var options = {
		zoom: 10,
		panControl:false,
